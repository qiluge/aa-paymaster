...
export interface QuotaPaymasterInterface extends utils.Interface {
  functions: {
    "addStake(uint32)": FunctionFragment;
    "configQuota(address[],uint256[])": FunctionFragment;
...
export interface QuotaPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QuotaPaymasterInterface;
  ...
  functions: {
    ...
    configQuota(
      ...
      _quotas: PromiseOrValue<BigNumberish>[],

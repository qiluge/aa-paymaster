...
export interface SponsorDepositPaymasterInterface extends utils.Interface {
  functions: {
    ...
    "setSponsors(address,address[],uint256[])": FunctionFragment;
    "sponsors(address,address,address)": FunctionFragment;
...
export interface SponsorDepositPaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SponsorDepositPaymasterInterface;
